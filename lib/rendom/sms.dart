...
List<String> number = ["9924824259","8511672777"];
...
class _MyAppState extends State<MyApp2>
{
            ...
            child: Center(
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    _sendSMS(message: "This is Test message!", recipients: number);
                  },
                ),
              ),
            ),
  ...
  {
    String result = await sendSMS(message: message, recipients: recipients).catchError((onError){print(onError);});
    print(result);
  }
}
